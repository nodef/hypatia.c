...
And then include `hypatia.h` as follows:
```c
#include "node_modules/hypatia.c/hypatia.h"
```
...
![](https://ga-beacon.deno.dev/G-RC63DPBH3P:SH3Eq-NoQ9mwgYeHWxu7cw/github.com/nodef/hypatia.c)
[![SRC](https://img.shields.io/badge/src-repo-green?logo=Org)](https://github.com/dagostinelli/hypatia)
